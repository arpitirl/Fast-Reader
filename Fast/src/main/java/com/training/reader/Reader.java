...
public class Reader {
	...
	public Dictionary read(MultipartFile file) throws IOException {
		file.transferTo(new File("C:\\Users\\arpit.shreshth\\zee_ent\\Fast\\src\\main\\resources"+file.getOriginalFilename()));
		System.out.println("Reader");
		String dest="C:\\Users\\arpit.shreshth\\zee_ent\\Fast\\src\\main\\resources"+file.getOriginalFilename();
